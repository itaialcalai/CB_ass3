...
def main():
    ...
    parser.add_argument('samples_file', help='Input samples file to train & test on', default="nn0.txt")
    parser.add_argument('--wnet_file', help='Serialized generated NN model file to write to', default="wnet0.json")
